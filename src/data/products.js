...
export const PRODUCTS = [
  ...
  },
  {
    ...
    slug: "atlas-sculpted-square-sunglasses",
    category: "Sunglasses",
  ...
  {
    id: "yb-opt-005",
    name: "Studio Titanium Optical Frame",
    slug: "studio-titanium-optical-frame",
    category: "Optical",
    subcategory: "Optical",
    price: 135000,
    currency: "NGN",
  ...
  {
    id: "yb-sun-008",
    name: "Elysian Aviator Monolith",
    slug: "elysian-aviator-monolith",
    category: "Sunglasses",
    subcategory: "Sunglasses",
    price: 130000,
    currency: "NGN",
  ...
  {
    id: "yb-acc-010",
    name: "Saffiano Eyewear & Jewelry Valet Folio",
    slug: "saffiano-eyewear-jewelry-valet-folio",
    category: "Accessories",
    subcategory: "Lifestyle",
    price: 65000,
    currency: "NGN",
    description: "A foldaway travel case engineered from cross-grain Saffiano leather with an ultra-soft microfiber interior lining. Houses two pairs of eyewear and dedicated compartments for rings and cufflinks.",
  ...
  {
    id: "yb-opt-011",
    name: "Bauhaus Round Wireframe Spectacles",
    slug: "bauhaus-round-wireframe-spectacles",
    category: "Optical",
    subcategory: "Optical",
    price: 115000,
    currency: "NGN",
  ...
  {
    id: "yb-sun-013",
    name: "Noir Cat-Eye Silhouette",
    slug: "noir-cat-eye-silhouette",
    category: "Sunglasses",
    subcategory: "Sunglasses",
    price: 120000,
    currency: "NGN",
...
export const CATEGORIES = [
  ...
  { id: "Optical", name: "Optical Frames", count: PRODUCTS.filter(p => p.category === "Optical").length },
